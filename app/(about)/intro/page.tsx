...
import pra from '../../../public/president1.png'
     ...
     <Button/>
      <div className='m-20' >
        ...
        <div className='flex justify-center' >
            ...
            <Image className='w-32 h-32 object-cover rounded-full object-top md:h-40 md:w-40' src={pra} alt={'Arif Alvi'}  ></Image>
            
          </div>
          <div className='flex justify-center flex-col items-center'>
          <h3 className='font-bold text-2xl text-slate-800'>Dr. Arif Alvi
            </h3>
            <text className='text-xs text-slate-800 text-center font-semibold'>President of the Islamic Republic of Pakistan</text>
            </div>
          <div className='text-justify '>
         
            <text className='text-slate-800 leading-7 '> Dr. Arif Alvi was sworn in as the 13th President of Islamic Republic of Pakistan on 9th September 2018. <br />
